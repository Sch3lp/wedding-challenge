...
interface WeddingBehavior {
    ...
    fun getAssignee(assigneeId: AssigneeId): Assignee
...
class Wedding(
    ...
    override fun getAssignee(assigneeId: AssigneeId): Assignee =
        assignees.firstOrNull { it.id == assigneeId }
            ?: error("Could not find assignee with id ${assigneeId.value}")
